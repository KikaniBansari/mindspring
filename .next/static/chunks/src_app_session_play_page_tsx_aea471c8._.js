...
"[project]/src/app/session/play/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameTimer.useEffect": ()=>{
            ...
            const intervalId = setInterval({
                "GameTimer.useEffect.intervalId": ()=>{
                    setTimeLeft({
                        "GameTimer.useEffect.intervalId": (prev)=>prev - 1
                    }["GameTimer.useEffect.intervalId"]);
                }
            }["GameTimer.useEffect.intervalId"], 1000);
            return ({
                "GameTimer.useEffect": ()=>clearInterval(intervalId)
            })["GameTimer.useEffect"];
        }
    }["GameTimer.useEffect"], [
        timeLeft,
...
_s(GameTimer, "T1YEL2Dn3PoZgNIcd8vH/k32Cls=");
_c = GameTimer;
...
const WaveSorterGame = ({ onThoughtsChange })=>{
    ...
    const [waves, setWaves] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [draggedWave, setDraggedWave] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WaveSorterGame.useEffect": ()=>{
            const getSpawnInterval = {
                "WaveSorterGame.useEffect.getSpawnInterval": ()=>{
            ...
            const spawnInterval = setInterval({
                "WaveSorterGame.useEffect.spawnInterval": ()=>{
                    ...
                    setWaves({
                        "WaveSorterGame.useEffect.spawnInterval": (prev)=>[
                                ...prev,
                                newWave
                            ]
                    }["WaveSorterGame.useEffect.spawnInterval"]);
                }
            }["WaveSorterGame.useEffect.spawnInterval"], getSpawnInterval());
            const timerInterval = setInterval({
                "WaveSorterGame.useEffect.timerInterval": ()=>{
                    timeElapsed.current += 1;
                }
            }["WaveSorterGame.useEffect.timerInterval"], 1000);
            return ({
                "WaveSorterGame.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WaveSorterGame.useEffect": ()=>{
            const animationInterval = setInterval({
                "WaveSorterGame.useEffect.animationInterval": ()=>{
                    setWaves({
                        "WaveSorterGame.useEffect.animationInterval": (prev)=>prev.map({
                                "WaveSorterGame.useEffect.animationInterval": (wave)=>{
                                    if (wave.isReturning) {
                            ...
                            }["WaveSorterGame.useEffect.animationInterval"]).filter({
                                "WaveSorterGame.useEffect.animationInterval": (wave)=>wave.y > -50
                            }["WaveSorterGame.useEffect.animationInterval"]) // Remove waves that have gone off-screen
                    }["WaveSorterGame.useEffect.animationInterval"]);
                }
            }["WaveSorterGame.useEffect.animationInterval"], 30);
            return ({
                "WaveSorterGame.useEffect": ()=>clearInterval(animationInterval)
            })["WaveSorterGame.useEffect"];
        }
    }["WaveSorterGame.useEffect"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: laneColors.map((color, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(WaveSorterGame, "TZUWhuIh0CRfbsyQpJZE1mBsNoA=");
_c1 = WaveSorterGame;
...
const TensionThreadsGame = ({ onThoughtsChange })=>{
    ...
    const [threads, setThreads] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialThreads);
    const gameAreaRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Game loop for tension increase
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TensionThreadsGame.useEffect": ()=>{
            const gameInterval = setInterval({
                "TensionThreadsGame.useEffect.gameInterval": ()=>{
                    setThreads({
                        "TensionThreadsGame.useEffect.gameInterval": (prevThreads)=>prevThreads.map({
                                "TensionThreadsGame.useEffect.gameInterval": (thread)=>({
                                        ...thread,
            ...
            }["TensionThreadsGame.useEffect.gameInterval"], 100);
            // Stress waves
            const waveInterval = setInterval({
                "TensionThreadsGame.useEffect.waveInterval": ()=>{
                    setThreads({
                        "TensionThreadsGame.useEffect.waveInterval": (prevThreads)=>prevThreads.map({
                                "TensionThreadsGame.useEffect.waveInterval": (thread)=>({
                                        ...thread,
                    ...
                    onThoughtsChange({
                        "TensionThreadsGame.useEffect.waveInterval": (prev)=>prev + "w"
                    }["TensionThreadsGame.useEffect.waveInterval"]);
                }
            }["TensionThreadsGame.useEffect.waveInterval"], 6000);
            return ({
                "TensionThreadsGame.useEffect": ()=>{
...
_s2(TensionThreadsGame, "mdxSALBnaZvgEiUxkxIs9AgVQv8=");
_c2 = TensionThreadsGame;
...
const ThoughtConstellationsGame = ({ onThoughtsChange })=>{
    ...
    const [previewLine, setPreviewLine] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const spawnStar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ThoughtConstellationsGame.useCallback[spawnStar]": ()=>{
            const gameArea = gameAreaRef.current?.getBoundingClientRect();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThoughtConstellationsGame.useEffect": ()=>{
            // Initial spawn
            const initialStars = [];
            for(let i = 0; i < 15; i++){
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThoughtConstellationsGame.useEffect": ()=>{
            const interval = setInterval({
                "ThoughtConstellationsGame.useEffect.interval": ()=>{
                    setStars({
                        "ThoughtConstellationsGame.useEffect.interval": (prev)=>{
                            if (prev.length < 20) {
                                return [
                                    ...prev,
                                    spawnStar()
            ...
            }["ThoughtConstellationsGame.useEffect.interval"], 3000);
            return ({
                "ThoughtConstellationsGame.useEffect": ()=>clearInterval(interval)
            })["ThoughtConstellationsGame.useEffect"];
        }
    }["ThoughtConstellationsGame.useEffect"], [
        spawnStar
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                        ...
                        children: [
                            ...
                            previewLine && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("line", {
                                x1: previewLine.x1,
                                y1: previewLine.y1,
                                x2: previewLine.x2,
                                y2: previewLine.y2,
...
_s3(ThoughtConstellationsGame, "K3jTQwy/TepVVR365koH8XyqGOQ=");
_c3 = ThoughtConstellationsGame;
// --- FOG LIFT GAME (Foggy) ---
const FoggyGame = ({ onThoughtsChange })=>{
    _s4();
    const [cleared, setCleared] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Array(5).fill(null).map({
        "FoggyGame.useState": ()=>Array(5).fill(false)
    }["FoggyGame.useState"]));
    const [fogOpacity, setFogOpacity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const clearedCountRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(0);
...
_s4(FoggyGame, "EuIp6lXfb5KwqaE1vkvAbqwKNqw=");
_c4 = FoggyGame;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EnergyThreadGame.useEffect": ()=>{
            if (nodes.length > 0 && lines.length === nodes.length / 2) {
                onThoughtsChange({
                    "EnergyThreadGame.useEffect": (prev)=>prev + "||"
                }["EnergyThreadGame.useEffect"]);
...
_s5(EnergyThreadGame, "xzmsW0Gur1sIbSb6ZfJrOJAp6nM=");
_c5 = EnergyThreadGame;
...
_s6(MindAlignGame, "Z+t/7/UT4uPPiumWaGLbziloI/E=");
_c6 = MindAlignGame;
function PlaySession() {
    ...
    const [clearedThoughts, setClearedThoughts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const handleTimeUp = ()=>{
    ...
    const renderGameForMood = ()=>{
        switch(mood){
            case 'Overwhelmed':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WaveSorterGame, {
            ...
            case 'Stressed':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TensionThreadsGame, {
                    onThoughtsChange: setClearedThoughts
                }, void 0, false, {
                    fileName: "[project]/src/app/session/play/page.tsx",
                    lineNumber: 727,
            ...
            case 'Confused':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MindAlignGame, {
                    onThoughtsChange: setClearedThoughts
                }, void 0, false, {
                    fileName: "[project]/src/app/session/play/page.tsx",
                    lineNumber: 729,
            ...
            case 'Foggy':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FoggyGame, {
                    onThoughtsChange: setClearedThoughts
                }, void 0, false, {
                    fileName: "[project]/src/app/session/play/page.tsx",
                    lineNumber: 731,
            ...
            case 'Tired':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EnergyThreadGame, {
                    onThoughtsChange: setClearedThoughts
                }, void 0, false, {
                    fileName: "[project]/src/app/session/play/page.tsx",
                    lineNumber: 733,
            ...
            case 'Full Mind':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ThoughtConstellationsGame, {
                    onThoughtsChange: setClearedThoughts
                }, void 0, false, {
                    fileName: "[project]/src/app/session/play/page.tsx",
                    lineNumber: 735,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GameTimer, {
...
_s7(PlaySession, "q1s/Bdo6gRgVbscSSghBOsFZtoc=", false, function() {
    return [
...
function SessionPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PlaySession, {}, void 0, false, {
            fileName: "[project]/src/app/session/play/page.tsx",
            lineNumber: 753,
            columnNumber: 7
        }, this)
...
__turbopack_context__.k.register(_c1, "WaveSorterGame");
__turbopack_context__.k.register(_c2, "TensionThreadsGame");
__turbopack_context__.k.register(_c3, "ThoughtConstellationsGame");
__turbopack_context__.k.register(_c4, "FoggyGame");
__turbopack_context__.k.register(_c5, "EnergyThreadGame");
__turbopack_context__.k.register(_c6, "MindAlignGame");
__turbopack_context__.k.register(_c7, "PlaySession");
__turbopack_context__.k.register(_c8, "SessionPage");
...
//# sourceMappingURL=src_app_session_play_page_tsx_aea471c8._.js.map